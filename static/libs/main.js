...
const rwstLayer = L.geoJSON(rwst, {
	...
	.bindPopup(function (rwst) {
		...
		rwstPhoto = '<br><img src="' + rwst.feature.properties.Фото + '" width="285" height="190"> '
        rwstOpis = '<br>"'+rwst.feature.properties.Photo+'"'
		return '<b>Название памятника: </b>'   + rwst.feature.properties.Название + rwstOpis + rwstPhoto
